...
INSERT INTO `pt_operator` VALUES ('d08606ba8bf640eca76413dbfc947f56', '0', null, '密码变更', null, null, null, '0', '/jf/platform/user/passChange', '8a40c0353fa828a6013fa898d4ac0030', '0', '0', '0', '1', null, null, '用户');
...
CREATE TABLE `pt_user` (
  ...
  `salt` blob,
  `status` char(1) COLLATE utf8_bin DEFAULT NULL,
  `stopdate` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
